...
$query = $pdo->query("SELECT * from reservas where data_reser >= '$dataInicioMes' and data_reser <= curDate()");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-9 text-end">
                                        <h3> <span class="text-success"><?php echo @$total_prod ?></span></h3>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-9 text-end">
                                        <h3> <span class=""><?php echo @$total_forn ?></span></h3>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="align-self-center col-3">
                                        <i class="bi bi-border-width text-info fs-1 float-start"></i>
                                    </div>
                                    <div class="col-9 text-end">
                                        <h3><?php echo @$total_pratos ?></h3>
                                        <span>Pratos</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-content">
                            <div class="card-body cleartfix">
                                <div class="row media align-items-stretch">
                                    <div class="align-self-center col-1">
                                        <i class="bi bi-handbag-fill text-success fs-1 mr-2"></i>
                                    </div>
                                    <div class="media-body col-6">
                                        <h4>Total de Reservas</h4>
                                        <span>Reservas feitas no Mês</span>
                                    </div>
                                    <div class="text-end col-5">
