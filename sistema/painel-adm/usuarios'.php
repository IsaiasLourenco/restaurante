...
<body>
	<h2>FUNCIONÁRIOS</h2>
	<a href="index.php?pag=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-primary">Novo Funcionario</a>
			...
			<div class="modal-content">
				...
				<form method="post" id="form" name="frmFunc">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-seconsary" data-bs-dismiss="modal" id="btn-fechar">Fechar</button>
	...
	<div class="modal fade" id="modal-dados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="btn-fechar-excluir">Fechar</button>
				</div>
			</div>
		</div>
	</div>
