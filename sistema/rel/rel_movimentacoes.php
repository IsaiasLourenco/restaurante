...
<body>
    ...
    <div class="container">
        ...
        <div align="center" class="">
            <span class="titulorel">Movimentações <?php echo $status_serv  ?> </span>
        </div>
        ...
        <table class='table' width='100%' cellspacing='0' cellpadding='3'>
            ...
            <?php
            $saldo = 0;
            $query = $pdo->query("SELECT * FROM movimentacoes WHERE data_mov >= '$dataInicial' AND data_mov <= '$dataFinal' AND tipo LIKE '$status_like' ORDER BY id ASC");
