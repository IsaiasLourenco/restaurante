...
<body>
    ...
    <div class="container">
        ...
        <div align="center" class="">
            <span class="titulorel">Comissões de <?php echo $nome_garcom ?> </span>
        </div>
        <small>
            <table class='table' width='100%' cellspacing='0' cellpadding='3'>
                ...
                $comissao = 0;
                $total_comissao = 0;
                $query = $pdo->query("SELECT * FROM pedidos WHERE data_pedido >= '$dataInicial' AND data_pedido <= '$dataFinal' AND pago = 'Sim' AND comissao > 0 AND garcom = '$id' ORDER BY data_pedido ASC");
                $res = $query->fetchAll(PDO::FETCH_ASSOC);
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; color:red"><strong>R$ <?php echo number_format($res[$i]['comissao'], 2, ',', '.') ?></strong></td>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 direita" align="right">
                <span class=""> <b> Total Comissão: R$ <?php echo number_format($total_comissao, 2, ',', '.') ?> </b> </span>
            </div>
        </div>
