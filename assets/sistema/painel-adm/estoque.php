			...
			<tbody>
				...
				?>
					<tr>
						...
						<td style="text-align:center"><img src="../../assets/imagens/produtos/<?php echo $res[$i]['imagem'] ?>" height="20px" width="30px"></td>
...
<script type="text/javascript">
	function dados(nome, valor_compra, valor_venda, categoria, fornecedor, estoque, imagem, descricao) {
		...
		$('#imagem_registro').attr('src', '../../assets/imagens/produtos/' + imagem);
