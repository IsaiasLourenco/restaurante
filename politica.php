...
<head>
    ...
    <title><?php echo $nome_site ?>-Política de Privacidade</title <meta charset="utf-8">
...
<body>
    ...
    <nav style="background-color: black;" class="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
    ...
    <p>A sua privacidade é importante para nós. É política do Lorenzo's Restaurante respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=www.lorenzos.sitepessoal.com>Lorenzo's Restaurante</a>, e outros sites que possuímos e operamos.</p>
    ...
    <p>O site é confiável e seguro para o usuário conforme informado pelo <a target='_BLANK' style='color: #616060;text-decoration: none;' href='https://sitecheck.com.br' rel='noopener noreferrer'>Site Check</a>. A página verifica informações do site para identificar possíveis problemas de segurança. </p>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Lorenzo's Restaurante oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ul>
    ...
    <p> O usuário pode bloquear e/ou desativar os cookies de qualquer site, inclusive o nosso a qualquer momento. Para realizar esse procedimento, acesse as configurações do seu browser. Consulte abaixo guias de ajuda dos principais navegadores: </p>
    <ul>
